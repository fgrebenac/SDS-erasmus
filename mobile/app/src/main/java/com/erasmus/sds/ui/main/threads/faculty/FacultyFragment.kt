package com.erasmus.sds.ui.main.threads.faculty
...
class FacultyFragment : Fragment(R.layout.fragment_threads) {
    ...
    private fun initViews() = binding.apply {
        addThreadButton.onClickDebounced { findNavController().navigate(FacultyFragmentDirections.openCreateThread()) }
    }
